...
#define GIT_CLONE_OPTIONS_INIT { GIT_CLONE_OPTIONS_VERSION, __GIT_PADDING__, \
    { GIT_CHECKOUT_OPTIONS_VERSION, GIT_CHECKOUT_SAFE }, \
    GIT_FETCH_OPTIONS_INIT }


#define GIT_FETCH_OPTIONS_VERSION 1
#define GIT_FETCH_OPTIONS_INIT { GIT_FETCH_OPTIONS_VERSION, __GIT_PADDING__, \
    GIT_REMOTE_CALLBACKS_INIT, GIT_FETCH_PRUNE_UNSPECIFIED, 1, \
    GIT_REMOTE_DOWNLOAD_TAGS_UNSPECIFIED, __GIT_PADDING__, GIT_PROXY_OPTIONS_INIT }
...
typedef int GitCredentialDefaultNew(git_credential **out);
typedef int GitCredentialUsernameNew(git_credential **out, const char *username);
typedef int GitCredentialUserpassPlaintextNew(git_credential **out, const char *username, const char *password);
...
typedef struct Git2Code
{
    ...
    GitCredentialDefaultNew *git_credential_default_new;
    GitCredentialUsernameNew *git_credential_username_new;
    GitCredentialUserpassPlaintextNew *git_credential_userpass_plaintext_new;
...
static char g_git_temporary_dir[MAX_PATH_LEN];
